...
//        String[] executeCmd = new String[]{"C:\\Program Files\\MySQL\\MySQL Server 5.6\\bin\\mysql", "projectkoala", "-u" + info[0], "-p" + info[1], "-e", " source " + path};
     String[] executeCmd = new String[]{"C:\\Program Files\\MySQL\\MySQL Server 5.6\\bin\\mysql", "--user=" + info[0], "--password=" + info[1],  "projectkoala","-e", "source "+path};
...
//                executeCmd = new String[]{"C:\\Program Files (x86)\\MySQL\\MySQL Server 5.6\\bin\\mysql", "projectkoala", "-u" + info[0], "-p" + info[1], "-e", " source " + path};
                executeCmd = new String[]{"C:\\Program Files (x86)\\MySQL\\MySQL Server 5.6\\bin\\mysql", "--user=" + info[0], "--password=" + info[1],  "projectkoala","-e", "source "+path};
                runtimeProcess = Runtime.getRuntime().exec(executeCmd);

...
public class ThongBaoKyGeVer2 extends javax.swing.JFrame implements Printable {
   ...
   //            new Get().BangTrongMuon(bangDSTrongMuon);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/com/Dialog/Untitled.png"))); // NOI18N
        ...
        jLabel9.setText("Họ và tên học sinh");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "Học phí", null, null, null},
                {"2", "Cơ sở vật chất", null, null, null},
                {"3", "Phí xe buýt", null, null, null},
                {"4", "Phí trông muộn", null, null, null},
                {"5", "Học phí các môn ngoại khóa", null, null, null},
                {"6", "Các khoản phải nộp khác", null, null, null},
                {"7", "Các khoản hoàn phí", null, null, null},
                {"8", "Tổng cộng", null, null, null}
            },
            new String [] {
                "STT", "Nội dung", "Thời gian", "Số tiền", "Ghi chú"
            }
        ));
        ...
        jLabel14.setText("Tuần 1");

        jLabel15.setText("Tuần 2");

        jLabel16.setText("Tuần 3");

        jLabel17.setText("Tuần 4");

        jLabel18.setText("Tuần 5");

        jLabel19.setText("Tuần 6");
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(ten, javax.swing.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
                                            .addComponent(jTextField3)
                                            .addComponent(jTextField4)
                                            .addComponent(lop, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jTextField10, javax.swing.GroupLayout.DEFAULT_SIZE, 369, Short.MAX_VALUE))))
                        .addGap(41, 41, 41))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThongBaoKyGeVer2().setVisible(true);
            }
        });
    }
    ...
    public int print(Graphics grphcs, PageFormat pf, int page) throws PrinterException {
       ...
       // grphcs.drawString(tableDataToString, 450, 250);
        ...
        grphcs.setFont(font);
        grphcs.drawString(lbHannop + ": ", 70, 540);
        grphcs.drawString(lbLoaiTien + ": ", 70, 560);
        grphcs.drawString(lbHinhThuc + ": ", 70, 580);
        grphcs.drawString(lbThongTin, 70, 600);
        font = new Font("Serif", Font.PLAIN, 13);
        grphcs.setFont(font);
        grphcs.drawString(lbTenTK + ": ", 100, 620);
        grphcs.drawString(lbSTK + ": ", 100, 640);
        grphcs.drawString(lbTenNH + ": ", 100, 660);
        
        grphcs.drawString(tfHannop, 130, 540);
        grphcs.drawString(tfLoaiTien, 200, 560);
        grphcs.drawString(tfHinhThuc, 200, 580);
        grphcs.drawString(tfTenTK, 190, 620);
        grphcs.drawString(tfSTK, 190, 640);
        grphcs.drawString(tfTenNH, 190, 660);
        
        font = new Font("Serif", Font.BOLD, 13);
        grphcs.setFont(font);
        grphcs.drawString(lbLuuy, 70, 700);
    ...
    public void getComponenets() {
      ...
      //  tfHovaTen = jTextField1.getText();
        tfLop = ten.getText();
        tfCoSo = jTextField3.getText();
        tfChuongTrinh = jTextField4.getText();

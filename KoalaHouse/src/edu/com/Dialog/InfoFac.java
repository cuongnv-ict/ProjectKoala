 ...
 */
public class InfoFac extends javax.swing.JFrame {

    /**
     * Creates new form InfoFac
     */
    public int idFac = 0;
    public InfoFac() {
        initComponents();
        ArrayList a;
        a = new Get().getInFoFac();
        addr.setText(a.get(0).toString());
        sdt.setText(a.get(1).toString());
        idFac = Integer.parseInt(a.get(2).toString());
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(addr, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
                            .addComponent(sdt)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(160, 160, 160)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Get().UpdateInfoFac(idFac, Add, SDT);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoFac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

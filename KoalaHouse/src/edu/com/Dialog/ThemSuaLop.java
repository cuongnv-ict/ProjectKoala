...
public class ThemSuaLop extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        trinhdo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "NẮNG MAI (SUNSHINE)", "TỔ ONG (BEEHIVE)", "TỔ KÉN (CHRYSALIS)", "MẪU GIÁO (KINDERGARTEN)" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(title, javax.swing.GroupLayout.PREFERRED_SIZE, 626, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addGroup(layout.createSequentialGroup()
                .addGap(26, 26, 26)
                .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
                .addComponent(ten, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(44, 44, 44)
        ...
        if(tengiaovien!=null&&tenlop!=null)
        {
            ...
            else
            {
                ...
                {    
                    ...
                    {
                        String message =String.format( "Bạn đã chỉnh sửa thành công");
                        JOptionPane.showMessageDialog( null, message );
                        button=true;
                        dispose();
                    }
